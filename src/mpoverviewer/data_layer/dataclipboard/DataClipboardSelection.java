...
// * @author J
// */
//public class DataClipboardSelection extends ArrayList<MeasureLine> {
//
//    /**
//     * A mock song structure with SONG_LENGTH number of MeasureLines that will
//     * represent the clipboard contents.
//     */
//    private static List<MeasureLine> selection;// = new ArrayList<>(Constants.SONG_LENGTH);
//
...
//            DataClipboardSelection.content.add(new MeasureLine());
//        }
//        DataClipboardSelection.content.addAll(content);
//    }
//
//    /**
//     *
...
//        DataClipboardSelection.instrFiltered = instrFiltered;
//    }
//
